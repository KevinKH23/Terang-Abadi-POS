...
<ul class="c-header-nav ml-auto mr-4">
    ...
    <li class="c-header-nav-item dropdown d-md-down-none mr-2">
        <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            ...
            @php
                $low_quantity_products = \Modules\Product\Entities\Product::select('id', 'product_quantity', 'product_stock_alert', 'product_name')->whereColumn('product_quantity', '<=', 'product_stock_alert')->get();
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0">
            ...
            @forelse($low_quantity_products as $product)
                <a class="dropdown-item" href="{{ route('products.show', $product->id) }}">
                    <i class="bi bi-hash mr-1 text-primary"></i> Peringatan! Stok "{{ $product->product_name }}" memiliki jumlah rendah!
                </a>
            @empty
