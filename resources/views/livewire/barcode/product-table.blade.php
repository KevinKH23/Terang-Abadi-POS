                ...
                <table class="table table-bordered mb-0">
                    ...
                    <tr class="align-middle">
                        ...
                        <th class="align-middle">
                            Jumlah <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Jumlah Maks: 100"></i>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        ...
                        @else
                            <td colspan="3" class="text-center">
                                <span class="text-danger">Cari & pilih barang!</span>
                            </td>
                        @endif
                    </tr>
                    </tbody>
