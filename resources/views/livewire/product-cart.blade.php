        ...
        <div class="table-responsive position-relative">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th class="align-middle text-center">Harga per Unit</th>
    ...
    <div class="form-row">
        <div class="col-lg-4">
            <div class="form-group">
                ...
                <input wire:model.blur="global_tax" type="number" class="form-control" name="tax_percentage" min="0" max="11" value="{{ $global_tax }}" required>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="form-group">
        ...
        <!-- <div class="col-lg-4">
            <div class="form-group">
                <label for="shipping_amount">Shipping (Jika ada)</label>
