            ...
            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_supplier" id="product_supplier">
                                            <option value="" {{ old('product_supplier', $product->product_supplier) ? '' : 'selected' }}>Pilih Supplier</option>
                                            @foreach(\Modules\People\Entities\Supplier::all() as $supplier)
                                            <option value="{{ $supplier->supplier_name }}" {{ old('product_supplier', $product->product_supplier) === $supplier->supplier_name ? 'selected' : '' }}>
                                                {{ $supplier->supplier_name }}  | {{ $supplier->city }}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="images">Gambar Barang <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Max Files: 3, Max File Size: 1MB, Image Size: 400x400"></i></label>
...
@push('page_scripts')
        ...
        <!-- <form action="{{ route('dropzone.upload') }}" class="dropzone" id="document-dropzone"></form> -->
    <!-- <script>
        var uploadedDocumentMap = {}
        Dropzone.options.documentDropzone = {
            url: "{{ route('dropzone.upload') }}",
