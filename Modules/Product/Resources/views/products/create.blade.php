            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">Simpan Barang <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="product_code" value="{{ old('product_code') }}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_unit">Unit <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Singkatan unit akan tertera setelah stok barang"></i> <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_supplier">Supplier <span class="text-danger">*</span></label>
                                        <select class="form-control" name="product_supplier" id="product_supplier">
                                            <option value="" selected >Pilih Supplier</option>
                                            @foreach(\Modules\People\Entities\Supplier::all() as $supplier)
                                                <option value="{{ $supplier->supplier_id }}">{{ $supplier->supplier_name }} | {{ $supplier->city }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="image">Gambar Barang <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Max Files: 3, Max File Size: 1MB, Image Size: 400x400"></i></label>
...
@push('page_scripts')
        @php
            $mediaFiles = isset($product) ? $product->getMedia('images')->map(function ($file) {
                return [
                    'name' => $file->file_name,
                    'size' => $file->size,
        ...
        <script>
            var files = { json_encode($mediaFiles){}, };
        </script>
