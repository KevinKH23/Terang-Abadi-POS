                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="due_amount" required value="{{ format_currency($salePayment->due_amount) }}" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="amount">Jumlah Diterima <span class="text-danger">*</span></label>
                                    ...
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                <option {{ $salePayment->payment_method == 'Cash' ? 'selected' : '' }} value="Cash">Tunai</option>
                                                ...
                                                <option {{ $salePayment->payment_method == 'Other' ? 'selected' : '' }} value="Lainnya">Lainnya</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
