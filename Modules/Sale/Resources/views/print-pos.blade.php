            ...
            <tbody>
                <tr style="background-color:#ddd;">
                    <td class="centered" style="padding: 5px;">
                        {{ $sale->payment_method }}: {{ format_currency($sale->paid_amount) }}
                    </td>
                    <td class="centered" style="padding: 5px;">
                        Kembali: {{ format_currency($sale->due_amount) }}
                    </td>
                </tr>
                <tr style="border-bottom: 0;">
                    <td class="centered" colspan="3">
                        <p style="font-size: 12px; margin: 10px 0;">
                            Terima kasih telah berbelanja di {{ settings()->company_name }}!
                        </p>
