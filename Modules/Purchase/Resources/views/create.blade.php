                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="reference" required readonly value="PB">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="supplier_id" id="supplier_id" required>
                                                @foreach(\Modules\People\Entities\Supplier::all() as $supplier)
                                                    <option value="{{ $supplier->id }}">{{ $supplier->supplier_name }} | {{ $supplier->city }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                ...
                                                <!-- <option value="Credit Card">Dana</option>
                                                <option value="Bank Transfer">GoPay</option>
                                                <option value="Cheque">OVO</option> -->
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#product_id').change(function() {
                ...
                // Ajax request to get supplier name based on product id
                $.ajax({
                    url: '/get-supplier/' + productId,
                    type: 'GET',
