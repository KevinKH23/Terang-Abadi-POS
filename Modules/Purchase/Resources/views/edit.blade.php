                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="supplier_id" id="supplier_id" required>
                                                @foreach(\Modules\People\Entities\Supplier::all() as $supplier)
                                                    <option {{ $purchase->supplier_id == $supplier->id ? 'selected' : '' }} value="{{ $supplier->id }}">{{ $supplier->supplier_name }} | {{ $supplier->city }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option {{ $purchase->status == 'Dicicil' ? 'selected' : '' }} value="Dicicil">Dicicil</option>
                                            <!-- <option {{ $purchase->status == 'Ordered' ? 'selected' : '' }} value="Ordered">Ordered</option> -->
                                            <option {{ $purchase->status == 'Lunas' ? 'selected' : '' }} value="Lunas">Lunas</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
