                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="amount">Jumlah Bayar <span class="text-danger">*</span></label>
                                    ...
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                <option {{ $purchasePayment->payment_method == 'Cash' ? 'selected' : '' }} value="Tunai">Tunai</option>
                                                ...
                                                <option {{ $purchasePayment->payment_method == 'Other' ? 'selected' : '' }} value="Lainnya">Lainnya</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
