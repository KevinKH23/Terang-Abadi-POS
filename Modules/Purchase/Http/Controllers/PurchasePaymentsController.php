...
class PurchasePaymentsController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        DB::transaction(function () use ($request) {
            ...
            if ($due_amount == $purchase->due_amount) {
        ...
        toast('Pembayaran Berhasil Ditambah!', 'success');
    ...
    public function update(Request $request, PurchasePayment $purchasePayment) {
        ...
        DB::transaction(function () use ($request, $purchasePayment) {
            ...
            if ($due_amount == $purchase->due_amount + $purchasePayment->amount) {
                $payment_status = 'Belum Bayar';
            } elseif ($due_amount < 0) {
                $payment_status = 'Belum Lunas';
            } else {
        ...
        toast('Pembayaran Berhasil Diupdate!', 'info');
